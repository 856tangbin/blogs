...
categories: [统计方法, 蒙特卡洛方法]
tags: [pyMC, 贝叶斯推断, 后验分布, 变分推断]
pin: true
math: true
mermaid: true
---
...
![image-20230227172420711](../assets/images/2025-05-01-pyMC基本用法/image-20230227172420711.png)
...
![image-20230227172752122](../assets/images/2025-05-01-pyMC基本用法/image-20230227172752122.png)
...
![image-20230227174256321](../assets/images/2025-05-01-pyMC基本用法/image-20230227174256321.png)

```python
az.plot_posterior(idata) # for a plot of the posterior that is inspired by [Kruschke, 2014]
```

![image-20230227174410919](../assets/images/2025-05-01-pyMC基本用法/image-20230227174410919.png)
...
![image-20230227180705734](../assets/images/2025-05-01-pyMC基本用法/image-20230227180705734.png)
...
![image-20230228085644617](../assets/images/2025-05-01-pyMC基本用法/image-20230228085644617.png)
...
![image-20230228090322949](../assets/images/2025-05-01-pyMC基本用法/image-20230228090322949.png)
...
![image-20230228090814055](../assets/images/2025-05-01-pyMC基本用法/image-20230228090814055.png)
...
![image-20230228101923605](../assets/images/2025-05-01-pyMC基本用法/image-20230228101923605.png)
